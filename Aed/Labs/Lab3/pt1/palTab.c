...
void AlocaTabelaPalavras(char *ficheiro, st_texto *t)
{
  ...
  (*t).palavras = (char **)calloc((*t).n_total_palavras, sizeof(char *));
  if ((*t).palavras == NULL)
  {
    fprintf(stderr, "ERROR: not enough memory available!\n");
    exit(2);
  }
  (*t).ocorrencias = (int *)calloc((*t).n_total_palavras, sizeof(int));
  ...
  for (i = 0; i < (*t).n_total_palavras; i++)
  {
    ...
    (*t).palavras[i] = (char *)calloc(n_max_caracteres + 1, sizeof(char));
...
void EscreveFicheiro(char *ficheiro, st_texto *t)
{
  ...
  nome = (char *)calloc(strlen(ficheiro) + 1 + strlen(".palavras"), sizeof(char));
